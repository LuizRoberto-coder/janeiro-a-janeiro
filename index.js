        ...
        const quizData = [
            {
                question: "Quantas temporadas tem a série 'Luiz e Carliane'?",
                answers: ["2 temporadas", "3 temporadas", "4 temporadas", "5 temporadas"],
                correct: 1 // Corrigido para 3 temporadas
            },
            {
                question: "Qual é a classificação etária da série?",
                answers: ["14 anos", "16 anos", "18 anos", "Livre"],
                correct: 2
            },
            {
                question: "Em que data começamos a namorar?",
                answers: ["15 de maio", "24 de dezembro", "30 de maio", "1º de junho"],
                correct: 2 // Corrigido para 30 de maio
            },
            {
                question: "Qual é o tema principal da série?",
                answers: ["Ação e aventura", "Comédia", "Romance verdadeiro", "Ficção científica"],
                correct: 2
            },
            {
                question: "Quantas estrelas a série recebeu na avaliação?",
                answers: ["3 estrelas", "4 estrelas", "5 estrelas", "4.5 estrelas"],
                correct: 2
            },
            {
                question: "Qual frase melhor descreve a nossa serie?",
                answers: [
                    "Amor é complicado",
                    "Amor está a um clique de distância",
                    "Amor é impossível",
                    "Amor é temporário"
                ],
                correct: 1
            ...
            {
                question: "O que torna o amor de Luiz e Carliane especial?",
                answers: [
                    "É um amor virtual",
            ...
            {
                question: "Qual elemento é essencial para o nosso relacionamento?",
                answers: ["Dinheiro", "Fama", "Coração humano", "Tecnologia"],
                correct: 2
            },
            {
                question: "Como é retratado o nosso sentimento?",
                answers: [
                    "Como algo superficial",
                    "Como verdadeiro sentimento do coração",
                    "Como uma obrigação",
                    "Como um jogo"
                ],
                correct: 1
            ...
            {
                question: "Qual é a mensagem principal sobre o amor na série?",
                answers: [
                    "O amor sempre acaba",
                    "O amor é difícil de encontrar",
                    "A vida precisa do coração para amar",
                    "O amor é só uma ilusão"
                ],
                correct: 2
            }];
        ...
        const allMemoryImages = [
            ['images/imagem13.jpg', 'images/imagem12.jpg'],
            ['images/imagem11.jpg', 'images/imagem10.jpg'],
            ['images/imagem4.jpg', 'images/imagem3.jpg'],
        ];
